...
?>				
					<div class="9u">
					  <section>
					    <header>
								<h2 style="color:#660033">Purchase Order Payment</h2>
						  </header>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="2" align="center"><input type="submit" name="submit" id="submit" value="Make Payment" style="background-color:#b3f0ff;width:22%;height:90%;border-radius:20px;font-weight:bold"></td>
      </tr>
  </tbody>
</table>
</form>
