...
?>
					...
					<div class="9u">
						<section>
						  <header>
								<h2 style="margin-left:75px;color:#660033">WORKER REGISTRATION</h2>
							</header>
						  ...
						  <table width="991" height="556" border="2">
						    <tbody>
						      ...
						      <tr>
						        <td align="right">Work Profile (Kindly mention Work profile, experience, etc..)  <font color="#FF0000">*</font></td>
						      ...
						      <tr>
						        <td>&nbsp;</td>
						        <td><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#b3f0ff;width:13%;height:75%;border-radius:20px;font-weight:bold"></td>
					          </tr>
					        </tbody>
					      </table>
                          </form>
