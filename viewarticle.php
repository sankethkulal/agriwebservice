...
?>
					...
					<div class="9u">
						<section>
							<header>
								<h2 style="color:#660033">View Articles</h2>
							</header>
                            <?php
							...
							<table width="563" height="68" border="1" class="tftable">
							  ...
							  <tr>
								...
								<td>&nbsp; <a href='article.php?editid=$rs[article_id]'>Edit</a> <br><br><br> <a href='viewarticle.php?deleteid=$rs[article_id]' onclick='return delconfirm()'>Delete</a></td>
						      </tr>";
							  }
							  ?>
						  </table>
