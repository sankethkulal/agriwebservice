...
if(isset($_POST[submit]))
{
	...
	{ 
		$sql ="UPDATE purchase_request SET customer_id='$_SESSION[customerid]', product_id='$_POST[product]', quantity='$_POST[quantity]-quantity', request_date='$_POST[requestdate]', request_date_expire='$_POST[expirydate]', note='$_POST[note]', status='$_POST[status]' WHERE purchase_request_id='$_GET[editid]'";
...
<div id="featured">
   ...
   ?>
						<section>
							<header>
								<h2 style="color:#660033"><?php echo $rs[title]; ?></h2>
							</header>
<?php
include("salesslider.php");
?>
<br />
							<h2 style="color:#660033"><strong>Seller Information:</strong></h2>
							...
							<p><?php echo "<strong>Description: </strong>".$rs[description]; ?></p>
                                ...
                                <h2 style="color:#660033"><strong>Send A Purchase Request</strong></h2>
				...
				else
				{
						  ...
						  <table width="738" height="248" border="2">
						    <tbody>
						      ...
						      <tr>
						        <td height="15">&nbsp;</td>
						        <td><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#b3f0ff;width:14%;height:110%;border-radius:20px;font-weight:bold"></td>
					          </tr>
					        </tbody>
					      </table>
                          </form>
