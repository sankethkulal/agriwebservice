...
?>
					...
					<div class="9u">
						<section>
						  <header>
								<h2 style="color:#660033">Add A Variety</h2>
							</header>
						  ...
						  <table width="355" height="234" border="2">
						    <tbody>
						      ...
						      <tr>
						        <td>&nbsp;</td>
						        <td><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#b3f0ff;width:25%;height:80%;border-radius:20px;font-weight:bold"></td>
					          </tr>
					        </tbody>
					      </table>
                          </form>
