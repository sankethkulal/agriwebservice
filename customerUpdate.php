...
?>
					...
					<div class="9u">
						<section>
							<header>
								<h2 style="color:#660033">Your Profile Updated Here..</h2>
							</header>
							...
							<table width="1028" height="590" border="2">
                              ...
                              <input type="hidden" name="status" value="Active" >
							    ...
							    <tr>
							      <td height="72">&nbsp;</td>
							      <td><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#80ff80;width:10%;height:35%;border-radius:20px;font-weight:bold"autofocus></td>
						        </tr>
						      </table>
                          </form>
							<p>&nbsp;</p>
