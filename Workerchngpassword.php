                         ...
                         <input type="hidden" name="randnumber" value="<?php echo $randnumber; ?>" >
						  <table width="1013" height="245" border="2">
						    <tbody>
						      ...
						      <tr>
						        <td height="35">&nbsp;</td>
						        <td><input type="submit" name="submit" id="submit" value="Change Password" style="background-color:#b3f0ff;width:16%;height:70%;border-radius:20px;font-weight:bold"></td>
					          </tr>
					        </tbody>
					      </table>
                          </form>
