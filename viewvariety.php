...
?>
					...
					<div class="9u">
						<section>
						  <header>
								<h2 style="color:#660033"><?php echo "View ". $_GET[varietytype]." Variety"; ?></h2>
							</header>
						  <table width="955" height="55" border="1" class="tftable">
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[status]</td>
							  <td>&nbsp;<a href='variety.php?editid=$rs[variety_id]'>Edit</a> <br><br><br>  <a href='viewvariety.php?deleteid=$rs[variety_id]' onclick='return delconfirm()'>Delete</a></td>
					        </tr>";
							  }
							  ?>
					      </table>
