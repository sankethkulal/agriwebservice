...
?>
				  <div class="9u">
					  <section>
						  <header>
								<h2 style="color:#660033">Farm Produce</h2>
							</header>
                            <?php
						  ...
						  <table width="961" height="44" border="1" class="tftable">
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[status]</td>
							   <td>&nbsp; <a href='Product.php?editid=$rs[product_id]'>Edit</a> <br><br><br> <a href='viewProduct.php?deleteid=$rs[product_id]' onclick='return delconfirm()'>Delete</a></td>
					        </tr>";
							  }
							  ?>
					    </table>
