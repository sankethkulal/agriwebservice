...
?>
					...
					<div class="9u">
						<section>
							<header>
								<h2 style="color:#660033">Change Admin Password</h2>
							</header>
							...
							<table width="994" height="223" border="2">
							  <tbody>
							    ...
							    <tr>
							      <th scope="row">&nbsp;</th>
							      <td><input type="submit" name="changepassword" id="changepassword" value="Change Password" style="background-color:#b3f0ff;width:16%;height:60%;border-radius:20px;font-weight:bold"></td>
						        </tr>
						      </tbody>
						  </table>
                          </form>
