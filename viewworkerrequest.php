...
?>
					...
					<div class="9u">
						<section>
						  <header>
								<h2 style="color:#660033">Recruitment Details</h2>
							</header>
<?php
...
$date2 = new DateTime($rs[to_date]); 
								   ...
								   echo "<a href='viewworkerrequest.php?deleteid=$rs[worker_request_id]' onclick='return delconfirm()'>Delete</a> <br><br> <a href='viewworkerrequestdetailed.php?viewid=$rs[worker_request_id]'>View</a></td></tr>";
									}
							   }
							  ?> 
					        </tbody>
