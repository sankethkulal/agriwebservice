...
?>
					...
					<div class="9u">
						<section>
							<header>
								<h2 style="color:#660033">View Produce</h2>
							</header>
                            <?php
		                ...
		                <?php
        					  ...
        					  <tr>
							    ...
							    <td>&nbsp;$rs[status]</td>
								  <td>&nbsp; <a href='Produce.php?editid=$rs[produce_id]'>Edit</a> <br><br><br> <a href='viewProduce.php?deleteid=$rs[produce_id]' onclick='return delconfirm()'>Delete</a></td>
						      </tr>";
							  }
							  ?>
						  </table>
