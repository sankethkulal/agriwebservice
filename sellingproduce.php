...
?>
					...
					<div class="9u">
						<section>
						  <header>
								<h2 style="color:#660033">Add A Farm Produce</h2>
							</header>
						...
						<input type="hidden" name="randnumber" value="<?php echo $randnumber; ?>" >	
                          <table width="512" height="471" border="2">
							...
							?>
						      ...
						      <tr>
						        <td>&nbsp;</td>
						        <td><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#b3f0ff;width:19%;height:75%;border-radius:20px;font-weight:bold"></td>
					          </tr>
					        </tbody>
					      </table>
                          </form>
