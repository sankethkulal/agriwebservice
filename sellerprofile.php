...
?>
					...
					<div class="9u">
						<section>
						  <header>
								<h2 style="color:#660033">Update Seller Information</h2>
							</header> 
						  ...
						  <table width="451" height="564" border="2">
						    <tbody>
						      ...
						      <tr>
						        <td>&nbsp;</td>
						        <td><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#80ff80;width:40%;height:60%;border-radius:20px;font-weight:bold"></td>
					          </tr>
					        </tbody>
					      </table>
                          </form>
