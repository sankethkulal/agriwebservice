...
if(isset($_POST[submit]))
{
	...
	{
$sql="INSERT INTO seller(seller_name, seller_address, state_id, country_id, city_id, pincode, contact_number, mobile_no, email_id, aadhar_no, rtc_no, password, bank_name, bank_branch, bank_IFSC, bank_acno, status) VALUES ('$_POST[sellername]','$_POST[selleraddress]','$_POST[state]','$_POST[country]','$_POST[city]','$_POST[pincode]','$_POST[contactnumber]','$_POST[mbnumber]','$_POST[emailid]','$_POST[aadhar]','$_POST[rtcno]','$_POST[password]','$_POST[bankname]','$_POST[branch]','$_POST[ifsccode]','$_POST[bankacnumber]','Active')";	
	if(!mysqli_query($con,$sql))
		{
...
?>
					...
					<div class="9u">
						<section>
						  <header>
								<h2 style="margin-left:77px;color:#660033">FARMER REGISTRATION</h2>
							</header>
						  ...
						  <table width="1140" height="636" border="2">
						    <tbody>
						      <tr>
						        ...
						        <td width="967"><input type="text" name="sellername" id="sellername" value="<?php echo $rsedit[seller_name]; ?>" autofocus> <font color="gray"> (As per in Aadhaar Card) </font></td>
					          </tr>
						      <tr>
						      ...
						      <tr>
						        <td align="right">WhatsApp Number  <font color="#FF0000">*</font></td>
							  ...
							  <tr>
						        <td align="right">Aadhaar Number  <font color="#FF0000">*</font></td>
						        <td><input type="number" name="aadhar" id="aadhar" value="<?php echo $rsedit[aadhar_no]; ?>"><a style="font-weight:bold" href="https://resident.uidai.gov.in/verify">   Verify Aadhaar</a></td>
					          </tr>
							  <tr>
						        <td align="right">Survey Number  <font color="#FF0000">*</font></td>
						        <td><input type="number" name="rtcno" id="rtcno" value="<?php echo $rsedit[rtc_no]; ?>"><a style="font-weight:bold" href="https://rtc.karnataka.gov.in/Service78">   Verify RTC</a></td></td>
					          </tr>
						      <tr>
						      ...
						      <tr>
						        <td>&nbsp;</td>
						        <td><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#b3f0ff;width:11%;height:65%;border-radius:20px;font-weight:bold"></td>
					          </tr>
					        </tbody>
					      </table>
                          </form>
	...
	<script type="application/javascript">
      function validatesellreg()
	  {
		  	...
		  	else if(!document.frmsellreg.emailid.value.match(emailExp))
		{
		...
		else if(document.frmsellreg.aadhar.value == "")
		  {
			alert("Kindly enter the Aadhaar number..");
			document.frmsellreg.aadhar.focus();
			return false;
		  }
		  else if(document.frmsellreg.aadhar.value.length < 12)
		  {
		  ...
		  else if(document.frmsellreg.rtcno.value == "")
		  {
			alert("Kindly enter the Survey number..");
			document.frmsellreg.rtcno.focus();
			return false;
		  }
