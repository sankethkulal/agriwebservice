...
?>
					...
					<div class="9u">
						<section>
						  <header>
								<h2 style="color:#660033">Registered Farmers</h2>
							</header>
                            <?php
						  ...
						  <table width="943" height="65" border="1" class="tftable">
						    <tr>
							  ...
							  <th width="115"><strong>Aadhaar Number</strong></th>
							  <th width="115"><strong>Survey Number</strong></th>
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[status]</td>
						      <td>&nbsp;  <a href='verifyaadhaar.php?editid=$rs[seller_id]'>Edit</a> <br><br><br> <a href='viewseller.php?deleteid=$rs[seller_id]' onclick='return delconfirm()'>Delete</a></td>
					        </tr>";
							  }
							  ?>
					      </table>
