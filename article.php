...
?>
					...
					<div class="9u">
						<section>
							<header>
								<h2 style="margin-left:60px;color:#660033">Add An Article</h2>
							</header>
							...
							<table border="2">
							  <tbody>
							    ...
							    <tr>
							      ...
							      <td><input name="submit" type="submit" id="submit" value="Submit Article" style="background-color:#b3f0ff;width:27%;height:58%;border-radius:20px;font-weight:bold"></td>
						        </tr>
						      </tbody>
						  </table>
                          </form>
