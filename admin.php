...
?>
					...
					<div class="9u">
						<section>
							<header>
								<h2 style="color:#660033">Add An Admin</h2>
							</header>
                            ...
                            <table width="1108" height="207" border="2">
							  <tbody>
							    ...
							    <tr>
							      <th colspan="2" scope="row" align="center"><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#b3f0ff;width:8%;height:60%;border-radius:20px;font-weight:bold"></th>
						        </tr>
						      </tbody>
						  </table></form>
							<p>&nbsp;</p>
