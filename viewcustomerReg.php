...
?>
					...
					<div class="9u">
						<section>
							<header>
								<h2 style="color:#660033">Registered Customers</h2>
							</header>
                            <?php
...
PIN code: &nbsp;$rs[pincode]</td>
							    ...
							    <td>&nbsp;$rs[status]</td>
							    <td>&nbsp; <a href='customerReg.php?editid=$rs[customer_id]'>Edit</a> <br><br> <a href='viewcustomerReg.php?deleteid=$rs[customer_id]' onclick='return delconfirm()'>Delete</a></td>
						      </tr>";
							  }
							  ?>
						  </table>
