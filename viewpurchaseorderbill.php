...
?>
					...
					<div class="9u">
						<section>
						  <header>
								<h2 style="color:#660033">Purchase Request</h2>
							</header>
...
<input type="hidden" name="expdate" value="<?php echo $rs["request_date_expire"]; ?>">
    <table width="369" height="89" border="3">
      <tbody>
        ...
        <tr>
          <th scope="row">&nbsp;</th>
          <td><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#b3f0ff;width:32%;height:80%;border-radius:20px;font-weight:bold"></td>
        </tr>
      </tbody>
    </table>
</form>	
