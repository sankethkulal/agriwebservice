...
?>
					...
					<div class="9u">
						<section>
							<header>
								<h2 style="color:#660033">Seller Change Password</h2>
							</header>
							...
							<table width="1051" height="244" border="2">
							  <tbody>
							    ...
							    <tr>
							      <td>&nbsp;</td>
							      <td><input type="submit" name="submit" id="submit" value="Change Password" style="background-color:#b3f0ff;width:16%;height:60%;border-radius:20px;font-weight:bold"></td>
						        </tr>
						      </tbody>
						  </table>
                          </form>
