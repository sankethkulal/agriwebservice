...
?>
						...
						<section>
							...
							<table width="900" height="350" border="10" class="tftable">
							  <tbody>
								...
								<tr>
								  <th height="39" align="left"><strong>Aadhaar Number:</strong></th>
						          <td><?php echo $rsdisp[aadhar_no]; ?></td>
					            </tr>
							    <tr>
						          <th height="39" align="left"><strong>Survey Number:</strong></th>
						          <td><?php echo $rsdisp[rtc_no]; ?></td>
					            </tr>
							    <tr>
                ...
                <br />
                <header>
                    <h2 style="color:#660033">Worker Request Calendar</h2>
                </header>
                <?Php
