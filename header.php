...
<html> 
	<head>
		<title>AgriWebService - New Way Of Farming</title>
<style>
		@font-face {
    font-family: 'rupee';
...
.search_categories .select select{
  ...
  font-size: 1em;
	...
	<body class="homepage">
		...
		<div id="header" style="background-color:#ffe699;color:#a06450;" >
			<div class="container">

				
				<div id="logo">
					<h1><img src="images/logo.png" width="100" height="105" alt="Logo"  style="margin-top:-30px"/></a>					
                    </h1>
					<i><font style="color:#a06450;font-weight: bold;font-size:30px;font-family:impact">AgriWebService</font></i>
				</div>
			</div>
			<br>
           
				<nav id="nav" style="background-color:#ffe699;color:#A6905A;">
					<ul>
						<li
                        <?php
						...
						?>><a href="index.php" style="color:#332600;font-weight: bold;">Home</a></li>
						...
						?>
                            ...
                            ?>><a href="customerpanel.php"  style="color:#332600;font-weight: bold;">Customer Panel</a></li>
                        <?php
						}
						?>
						...
						?>
                            ...
                            ?>><a href="sellerpanel.php"  style="color:#332600;font-weight: bold;">Farmer Panel</a></li>
                        <?php
						}
						?>          
                         <?php
						...
						?>
                            ...
                            ?>><a href="workerpanel.php"  style="color:#332600;font-weight: bold;">Worker Panel</a></li>
                        <?php
						}
						?>              
						...
						?>
                            ...
                            ?>><a href="adminpanel.php"  style="color:#332600;font-weight: bold;">Dashboard</a></li>
                        <?php
						}
						?>
						...
						?>><a href="displayarticles.php?articletype=Blog"  style="color:#332600;font-weight: bold;">Blogs</a></li>
                        <li
                        <?php
						if(basename($_SERVER['PHP_SELF']) == "displayarticles.php")
						{
						...
						?>><a href="displayarticles.php?articletype=News"  style="color:#332600;font-weight: bold;">News</a></li>                  
						...
						?>><a href="displaysales.php"  style="color:#332600;font-weight: bold;">Farmer's Market</a></li>
                        <li
                        <?php
						...
						?>><a href="displayworkers.php"  style="color:#332600;font-weight: bold;">Hire</a></li>
						<li
                        <?php
						...
						?>><a href="feedback.php"  style="color:#332600;font-weight: bold;">Contact us</a></li>

						<div class="subnav">
							<button class="subnavbtn">Sign-up <i class="fa fa-caret-down"></i></button>
							<div class="subnav-content">
								<a href="customerloginpanel.php">  Customer</a><br>
								<a href="sellerloginpanel.php">Farmer</a><br>
								<a href="workerloginpanel.php">Worker</a><br>
								<a href="adminloginpanel.php">Admin</a><br>
							</div>
						</div> 						
