...
?>
					...
					<div class="9u">
						<section>
							<header>
								<h2 style="margin-left:40px;color:#660033">Customer Registration</h2>
							</header>
							...
							<table width="965" height="585" border="2">
                              ...
                              <input type="hidden" name="status" value="Active" >
							    ...
							    <tr>
							      <td>&nbsp;</td>
							      <td><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#b3f0ff;width:10%;height:25%;border-radius:20px;font-weight:bold"></td>
						        </tr>
						      </tbody>
						  </table>
                          </form>
