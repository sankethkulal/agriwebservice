						...
						<section>
							<header>
								 ...
								 if($_GET[cattype]=="Produce")
								 {
									...
									echo " <h2 style='color:#660033'>Add or Edit Produce Category</h2>";
								 }
							...
							<table width="414" height="278" border="2">
							  <tbody>
							    ...
							    <tr>
							      <th scope="row">&nbsp;</th>
							      <td><input type="submit" name="submit" id="submit" value="Submit" style="background-color:#b3f0ff;width:22%;height:45%;border-radius:20px;font-weight:bold"></td>
						        </tr>
						      </tbody>
						  </table>
                          </form>
