...
?>
					...
					<div class="9u">
						<section>
						  <header>
								<h2 style="color:#660033">Registered Workers</h2>
							</header>
                            <?php
						  ...
						  <table width="955" height="43" border="1" class="tftable">
						    ...
						    <tr>
						      ...
						      <td>&nbsp; 
							  <a href='worker.php?editid=$rs[worker_id]'>Edit</a><br><br>
							  <a href='viewworker.php?deleteid=$rs[worker_id]' onclick='return delconfirm()'>Delete</a>
