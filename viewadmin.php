...
?>
					...
					<div class="9u">
						<section>
							<header>
								<h2 style="color:#660033"> Admins Details</h2>
							</header>
							<?php
							...
							<table width="402" height="38" border="1" class="tftable">
							  ...
							  <tr>
							    ...
							    <td>&nbsp;$rs[login_id]</td>
							    <td>&nbsp;$rs[status]</td>
								 <td>&nbsp; <a href='admin.php?editid=$rs[admin_id]'>Edit</a> <br><br><a href='viewadmin.php?deleteid=$rs[admin_id]' onclick='return delconfirm()'>Delete</a></td>
						      </tr>";
							  }
							  ?>
						  </table>
